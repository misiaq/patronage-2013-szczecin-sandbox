 ...
 * Date: 1/29/13
 *
 * This class is a representation of REST token handler which is using by Spring Security for users
 ...
 */
public class TokenHandler extends TokenServicesUserApprovalHandler {
