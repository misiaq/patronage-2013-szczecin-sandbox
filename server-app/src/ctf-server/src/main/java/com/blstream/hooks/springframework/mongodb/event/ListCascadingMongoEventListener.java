 ...
 * Date: 1/23/13
 */
public class ListCascadingMongoEventListener extends AbstractMongoEventListener {
            ...
            public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                ...
                if (field.isAnnotationPresent(DBRef.class) && field.isAnnotationPresent(DBRefListCascade.class)) {
                    ...
                    if (fieldValue instanceof Collection<?>) {
                        ...
                        throw new MappingException("Cannot perform cascade save using DBRefListCascade annotation on not collection bean.");
                    }
                }
            }
        });
